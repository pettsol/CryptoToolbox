...
void tag_generation(hmac_state *cs, u8* tag, u8 *message, u64 dataLength, int tagSize);
int tag_validation(hmac_state *cs, u8 *tag, u8 *message, u64 dataLength, int tagSize);
