...
int main()
{
	...
	uint8_t key_1[BLOCKSIZE] = {0xAE, 0x68, 0x52, 0xF8, 0x12, 0x10, 0x67, 0xCC, 
			       0x4B, 0xF7, 0xA5, 0x76, 0x55, 0x77, 0xF3, 0x9E};

	uint8_t key_2[BLOCKSIZE] = {0x7E, 0x24, 0x06, 0x78, 0x17, 0xFA, 0xE0, 0xD7,
	       		       0x43, 0xD6, 0xCE, 0x1F, 0x32, 0x53, 0x91, 0x63};

	uint8_t key_3[BLOCKSIZE] = {0x76, 0x91, 0xBE, 0x03, 0x5E, 0x50, 0x20, 0xA8,
	       	               0xAC, 0x6E, 0x61, 0x85, 0x29, 0xF9, 0xA0, 0xDC};

	// This implementation
	// operates on 4 byte
	// words.
	uint8_t nonce_1[12] = {0x00, 0x00, 0x00, 0x30, 0x00, 0x00,
             	       0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

	uint8_t nonce_2[12] = {0x00, 0x6C, 0xB6, 0xDB, 0xC0, 0x54,
	       	       0x3B, 0x59, 0xDA, 0x48, 0xD9, 0x0B};

	uint8_t nonce_3[12] = {0x00, 0xE0, 0x01, 0x7B, 0x27, 0x77,
		       0x7F, 0x3F, 0x4A, 0x17, 0x86, 0xF0};
	
	uint8_t test_vector_1[16] = {0x53, 0x69, 0x6E, 0x67, 0x6C, 0x65, 0x20, 0x62,
	       			0x6C, 0x6F, 0x63, 0x6B, 0x20, 0x6D, 0x73, 0x67};

	// REVERSE
	//uint8_t r_key_1[16] = {0xF8, 0x52, 0x68, 0xAE, 0xCC, 0x67, 0x10, 0x12,
         //                 0x76, 0xA5, 0xF7, 0x4B, 0x9E, 0xF3, 0x77, 0x55};

//	uint8_t r_test_vector_1[16] = {0x67, 0x6E, 0x69, 0x53, 0x62, 0x20, 0x65, 0x6C,
//				  0x6B, 0x63, 0x6F, 0x6C, 0x67, 0x73, 0x6D, 0x20};
	//

	uint8_t ct_1[16] = {0xE4, 0x09, 0x5D, 0x4F, 0xB7, 0xA7, 0xB3, 0x79,
	               0x2D, 0x61, 0x75, 0xA3, 0x26, 0x13, 0x11, 0xB8};

	uint8_t test_vector_2[32] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		 	      	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
				0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
       				0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F};

	uint8_t ct_2[32] = {0x51, 0x04, 0xA1, 0x06, 0x16, 0x8A, 0x72, 0xD9,
	               0x79, 0x0D, 0x41, 0xEE, 0x8E, 0xDA, 0xD3, 0x88,
	   	       0xEB, 0x2E, 0x1E, 0xFC, 0x46, 0xDA, 0x57, 0xC8,
	       	       0xFC, 0xE6, 0x30, 0xDF, 0x91, 0x41, 0xBE, 0x28};

	uint8_t test_vector_3[36] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		 	      	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
				0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
       				0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F,
				0x20, 0x21, 0x22, 0x23};

	uint8_t ct_3[36] = {0xC1, 0xCF, 0x48, 0xA8, 0x9F, 0x2F, 0xFD, 0xD9,
